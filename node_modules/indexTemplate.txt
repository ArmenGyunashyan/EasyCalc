...
<script>
    ...
    var style = "<%= style %>";
    var statistics = <%-JSON.stringify(statistics)%>;   //Wird nur auf der Hauptseite benötigt
</script>
<script src="skripts/canvasJS.js"></script>             //Wird nur auf der Hauptseite benötigt
